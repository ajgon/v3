  ...
  new Element('h2').appendText('Picalily - Who are you?').injectInside($('detail'));
  rightColumn = new Element('div').setProperty('class', 'right-column').injectInside($('detail'));
    new Element('div').setProperties({'id': 'icon', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'alt': 'Logo of project picalily', 'src': 'images/portfolio/picalily_logo.png'}).injectInside($('icon'));
    new Element('div').setProperties({'id': 'preview', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'id': 'bigpreview', 'alt': 'Slice of project picalily', 'src': 'images/portfolio/picalily.png'}).injectInside($('preview'));
  new Element('img').setProperties({'id': 'thumb', 'alt': 'Sample page of project picalily', 'src': 'images/portfolio/picalily_view.png'}).injectInside($('detail'));
  info = new Element('div').setProperty('class', 'info').injectInside($('detail'));
    left = new Element('div').setProperty('class', 'left').injectInside(info);
      ...
      p = new Element('p').injectInside(left);
        new Element('a').setProperties({'href': 'http://www.picalily.com/', 'target': '_blank'}).appendText('http://www.picalily.com/').injectInside(p);
    ...
    right = new Element('div').setProperty('class', 'right').injectInside(info);
      ...
      new Element('p').appendText('Picalily is the place to instantly create a personalized Lifestory where our stories can be linked to those of family and friends.'). injectInside(right);
