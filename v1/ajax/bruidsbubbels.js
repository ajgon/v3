  ...
  new Element('h2').appendText('Maak een Boek en deel je felicitaties - BruidsBubbels').injectInside($('detail'));
  rightColumn = new Element('div').setProperty('class', 'right-column').injectInside($('detail'));
    new Element('div').setProperties({'id': 'icon', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'alt': 'Logo of project bruidsbubbels', 'src': 'images/portfolio/bruidsbubbels_logo.png'}).injectInside($('icon'));
    new Element('div').setProperties({'id': 'preview', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'id': 'bigpreview', 'alt': 'Slice of project bruidsbubbels', 'src': 'images/portfolio/bruidsbubbels.png'}).injectInside($('preview'));
  new Element('img').setProperties({'id': 'thumb', 'alt': 'Sample page of project bruidsbubbels', 'src': 'images/portfolio/bruidsbubbels_view.png'}).injectInside($('detail'));
  info = new Element('div').setProperty('class', 'info').injectInside($('detail'));
    left = new Element('div').setProperty('class', 'left').injectInside(info);
      ...
      p = new Element('p').injectInside(left);
        new Element('a').setProperties({'href': 'http://bruidsbubbels.nl/', 'target': '_blank'}).appendText('http://bruidsbubbels.nl/').injectInside(p);
    ...
    right = new Element('div').setProperty('class', 'right').injectInside(info);
      ...
      new Element('p').appendText('BruidsBubbels is an interactive community where you can share and celebrate your wedding with family and friends.'). injectInside(right);
