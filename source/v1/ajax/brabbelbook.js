  ...
  new Element('h2').appendText('Gratis online baby community - BrabbelBoek').injectInside($('detail'));
  rightColumn = new Element('div').setProperty('class', 'right-column').injectInside($('detail'));
    new Element('div').setProperties({'id': 'icon', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'alt': 'Logo of project brabbelbook', 'src': 'images/portfolio/brabbelbook_logo.png'}).injectInside($('icon'));
    new Element('div').setProperties({'id': 'preview', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'id': 'bigpreview', 'alt': 'Slice of project brabbelbook', 'src': 'images/portfolio/brabbelbook.png'}).injectInside($('preview'));
  new Element('img').setProperties({'id': 'thumb', 'alt': 'Sample page of project brabbelbook', 'src': 'images/portfolio/brabbelbook_view.png'}).injectInside($('detail'));
  info = new Element('div').setProperty('class', 'info').injectInside($('detail'));
    left = new Element('div').setProperty('class', 'left').injectInside(info);
      ...
      p = new Element('p').injectInside(left);
        new Element('a').setProperties({'href': 'http://brabbelboek.nl', 'target': '_blank'}).appendText('http://brabbelboek.nl').injectInside(p);
      new Element('h3').appendText('When?').injectInside(left);
      new Element('p').appendText('Sep 14, 2009'). injectInside(left);
    ...
    right = new Element('div').setProperty('class', 'right').injectInside(info);
      ...
      new Element('p').appendText('BrabbelBoek is a social community specifically for mothers, fathers and their babies. It is an interactive community that allows parents to celebrate and share their newborn baby.'). injectInside(right);
