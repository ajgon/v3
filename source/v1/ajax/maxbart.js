  ...
  new Element('h2').appendText('MAXBART - Budujemy na maxa!').injectInside($('detail'));
  rightColumn = new Element('div').setProperty('class', 'right-column').injectInside($('detail'));
    new Element('div').setProperties({'id': 'icon', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'alt': 'Logo of project maxbart', 'src': 'images/portfolio/maxbart_logo.png'}).injectInside($('icon'));
    new Element('div').setProperties({'id': 'preview', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'id': 'bigpreview', 'alt': 'Slice of project maxbart', 'src': 'images/portfolio/maxbart.png'}).injectInside($('preview'));
  new Element('img').setProperties({'id': 'thumb', 'alt': 'Sample page of project maxbart', 'src': 'images/portfolio/maxbart_view.png'}).injectInside($('detail'));
  info = new Element('div').setProperty('class', 'info').injectInside($('detail'));
    left = new Element('div').setProperty('class', 'left').injectInside(info);
      ...
      p = new Element('p').injectInside(left);
        new Element('a').setProperties({'href': 'http://www.maxbart.pl/', 'target': '_blank'}).appendText('http://www.maxbart.pl/').injectInside(p);
      new Element('h3').appendText('When?').injectInside(left);
      new Element('p').appendText('Oct 15, 2009'). injectInside(left);
    ...
    right = new Element('div').setProperty('class', 'right').injectInside(info);
      ...
      new Element('p').appendText('MaxBart is a building and renovations company established in 2007.'). injectInside(right);
