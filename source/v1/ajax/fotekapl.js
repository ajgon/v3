  ...
  new Element('h2').appendText('Foteka.pl - Hosting ObrazkÃ³w').injectInside($('detail'));
  rightColumn = new Element('div').setProperty('class', 'right-column').injectInside($('detail'));
    new Element('div').setProperties({'id': 'icon', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'alt': 'Logo of project fotekapl', 'src': 'images/portfolio/fotekapl_logo.png'}).injectInside($('icon'));
    new Element('div').setProperties({'id': 'preview', 'class': 'preview'}).injectInside(rightColumn);
      new Element('img').setProperties({'id': 'bigpreview', 'alt': 'Slice of project fotekapl', 'src': 'images/portfolio/fotekapl.png'}).injectInside($('preview'));
  new Element('img').setProperties({'id': 'thumb', 'alt': 'Sample page of project fotekapl', 'src': 'images/portfolio/fotekapl_view.png'}).injectInside($('detail'));
  info = new Element('div').setProperty('class', 'info').injectInside($('detail'));
    left = new Element('div').setProperty('class', 'left').injectInside(info);
      ...
      p = new Element('p').injectInside(left);
        new Element('a').setProperties({'href': 'http://www.foteka.pl/', 'target': '_blank'}).appendText('http://www.foteka.pl/').injectInside(p);
      new Element('h3').appendText('When?').injectInside(left);
      new Element('p').appendText('Mar 15, 2007'). injectInside(left);
    ...
    right = new Element('div').setProperty('class', 'right').injectInside(info);
      ...
      new Element('p').appendText('Page, designed as fast and simple host for favorites photos/pictures.'). injectInside(right);
